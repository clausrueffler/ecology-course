...
This kind of graph also makes clear important differences between the three types of survivorship curve. Note that on the linear graph, type II and type III curves have qualitatively similar shapes, whereas on the semi-log graph they look quite different. Furthermore, the survivorship curve with constant mortality becomes a straight line.
