...
```{r}
matplot(0:t, N, type = "p", pch = c(1,16), col = 1, ylim = c(0, 90), ylab="Number of individuals", xlab="Time")
...
matplot(0:t, N.r0p5, type = "p", pch = c(1,16), col = 1, ylim = c(0, 120), ylab="Number of individuals", xlab="Time")
abline(h = K1, lty = 3) # plots a line indicating the carrying capacity of species 1
text(0, K1+1, "K1", adj = c(0, 0))
legend("top", c(expression("species1 "), expression("species2")), pch = c(1,16), bty = "n")
```
