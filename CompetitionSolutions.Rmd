...
matplot(0:t, N$Species1, type = "b", pch =c(1,16), col = 1, ylim = c(0, 130), ylab="N", xlab="Time", main="r=0.5")
abline(h = 100, lty = 3)
...
matplot(0:t, N$Species1, type = "b", pch =c(1,16), col = 1, ylim = c(0, 130), ylab="N", xlab="Time", main="r=0.9")
abline(h = 100, lty = 3)
...
matplot(0:t, N$Species1, type = "b", pch =c(1,16), col = 1, ylim = c(0, 130), ylab="N", xlab="Time", main="r=1.5")
abline(h = 100, lty = 3)
#legend("top", c(expression("species1 "), expression("species2")), pch =c(1,16), bty = "n")
...
matplot(0:t, N$Species1, type = "b", pch =c(1,16), col = 1, ylim = c(0, 130), ylab="N", xlab="Time", main="r=1.9")
abline(h = 100, lty = 3)
#legend("top", c(expression("species1 "), expression("species2")), pch =c(1,16), bty = "n")
...
matplot(0:t, N$Species1, type = "b", pch =c(1,16), col = 1, ylim = c(0, 130), ylab="N", xlab="Time", main="r=2.1")
abline(h = 100, lty = 3)
#legend("top", c(expression("species1 "), expression("species2")), pch =c(1,16), bty = "n")
...
matplot(0:t, N$Species1, type = "b", pch =c(1,16), col = 1, ylim = c(0, 130), ylab="N", xlab="Time", main="r=2.4")
abline(h = 100, lty = 3)
#legend("top", c(expression("species1 "), expression("species2")), pch =c(1,16), bty = "n")
...
matplot(0:t, N$Species1, type = "b", pch =c(1,16), col = 1, ylim = c(0, 130), ylab="N", xlab="Time", main="r=2.5")
abline(h = 100, lty = 3)
#legend("top", c(expression("species1 "), expression("species2")), pch =c(1,16), bty = "n")
...
matplot(0:t, N$Species1, type = "b", pch =c(1,16), col = 1, ylim = c(0, 130), ylab="N", xlab="Time", main="r=2.6")
abline(h = 100, lty = 3)
...
The long-term outcome of the population dynamics is independent of the initial population size. In other words, the exact same cyclic pattern is reached for different initial population sizes. This is true as long as the population dynamics is not chaotic. 
...
In order to properly investigate the competition between two species, both need to have a non-zero density at *t=0*.
...
<!--
# I removed this, I guess I am overambitious...
